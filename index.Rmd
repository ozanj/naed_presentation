...
Most research analyzes admissions (CRYSTAL ADD EG) `r citep(bib[c("RN3536")])` or financial aid (CRYSTAL ADD EG) `r citep(bib[c("RN1948")])`
...
- Off-campus recruiting visits
    - College perspective `r citep(bib[c("RN3519")])`
