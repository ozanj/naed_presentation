...
for (i in 1:nrow(univs)) {
  cat(paste0('<li><a data-univ-id="', univs[i, 'univ_id'], '" data-univ-name="', univs[i, 'univ_name'], '" data-state-in="', univs[i, 'state_name'], '" data-metro-in="', univs[i, 'cbsa_title'], '">', univs[i, 'univ_name'], '</a></li>'))
}
```
</ul>
